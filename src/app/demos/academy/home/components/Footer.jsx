        ...
        <Row className="g-4">
          <Col lg={3}>
            ...
            <p className="my-3 text-body-secondary">
              EduGlobal education theme, built specifically for the education centers which is dedicated to teaching and involving learners.
            </p>
          ...
          <Container className="px-0">
            <div className="d-lg-flex justify-content-between align-items-center py-3 text-center text-md-left">
              <div className="text-body-secondary">
                ...
                Copyrights ©2024 EduGlobal. Build by
