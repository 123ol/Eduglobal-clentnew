              ...
              <div id="item-2">
                <Card className="bg-transparent">
                  ...
                  <CardBody className="px-0">
                    <p>
                      You can manage the setting for your <a href="#">EduGlobal account</a> at any time. Update your account information
                    </p>
                    ...
                    <ul className="list-group list-group-borderless mb-3">
                      ...
                      <li className="list-group-item d-flex pb-0">
                        <Link to="#" className="mb-0">
                          Why did my payment in a EduGlobal message fail?
                        </Link>
                      </li>
                    </ul>
                  </CardBody>
                ...
                <Card className="bg-transparent">
                  ...
                  <CardBody className="px-0">
                    ...
                    <ul className="list-group list-group-borderless mb-3">
                      ...
                      <li className="list-group-item d-flex pb-0">
                        <a href="#" className="mb-0">
                          When you pay for EduGlobal ads
                        </a>
                      </li>
                    </ul>
                  </CardBody>
