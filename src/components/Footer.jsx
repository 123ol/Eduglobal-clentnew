...
import logo from '@/assets/images/eglobal.svg';
import logoLight from '@/assets/images/eglobal.svg';
      ...
      <Container>
        <Row className="g-4">
          <Col lg={3}>
            ...
            <p className="my-3">
              EduGlobal education theme, built specifically for the education centers which is dedicated to teaching and involve learners.
            </p>
          ...
          <Container className="px-0">
            <div className="d-lg-flex justify-content-between align-items-center py-3 text-center text-md-left">
              <div className="text-body text-primary-hover">
                ...
                Copyrights ©{currentYear} EduGlobal. Build by
