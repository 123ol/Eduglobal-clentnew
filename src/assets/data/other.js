...
export const blogsData = [{
  ...
  id: '1003',
  title: 'Never underestimate the influence of EduGlobal',
...
export const eventScheduleData = [{
  ...
  events: [{
    avatar: avatar1,
    title: 'Grad Opening',
    description: 'by Lori Stevens Chairman of EduGlobal',
    ...
    description: 'by Larry Lawson Co-founder and Carolyn Ortiz EduGlobal Director',
